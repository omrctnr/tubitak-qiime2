...
my_Df_condition$feature_main[my_Df_condition$feature_main %in% "s_parvula"] <- "s_Veillonella parvula"
my_Df_condition$feature_main[my_Df_condition$feature_main %in% "s_parainfluenzae"] <- "s_Haemophilus parainfluenzae"
my_Df_condition$feature_main[my_Df_condition$feature_main %in% "s_mucosa"] <- "s_Neisseria mucosa"
my_Df_condition$feature_main[my_Df_condition$feature_main %in% "s_Paracoccus_s_"] <- "s_Unclassified Paracoccus"
my_Df_condition$feature_main[my_Df_condition$feature_main %in% "s_gordonii"] <- "s_Streptococcus gordonii"
...
my_Df_Site$feature_main[my_Df_Site$feature_main %in% "s_epidermidis"] <- "s_Staphylococcus<br>epidermidis"
my_Df_Site$feature_main[my_Df_Site$feature_main %in% "s_tuberculostearicum"] <- "s_Corynebacterium<br>tuberculostearicum"
...
ggsave(plot = combined_f2_f3_f4, "combined_f2_f3_f42.jpg",height = 10,width = 10)
